...
import { createThemeListener, isDarkMode } from "./theme-detection";
 ...
 * 获取自适应的边框颜色
 */
export function getAdaptiveBorderColor(
...
export function applyAdaptiveTheme(element: HTMLElement): void {
	...
	element.classList.remove(
		"theme-dark",
		"theme-light",
		"weave-adaptive-theme-dark",
		"weave-adaptive-theme-light"
	);
...
export function getChartThemeConfig() {
	...
	return {
		...
		textStyle: {
			...
			fontFamily:
				'var(--font-interface, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif)',
		},
		grid: {
