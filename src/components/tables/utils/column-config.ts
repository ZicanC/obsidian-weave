...
export const COLUMN_TOOLTIPS_EN: Record<ColumnKey, string> = {
	...
	ir_decks: "Topics this content block belongs to (compatible with legacy IR deck data)",
};

/**
 * 旧版列标签映射（向后兼容）
 * Compatibility note: 使用 getColumnLabel() 替代
 */
