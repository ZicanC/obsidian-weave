        ...
        <div class="card-display">
          ...
          <div class="card-front">
            <div class="card-content">
              <!-- /skip {@html} renders Markdown card content processed by Obsidian renderer -->{@html getCardFieldContent(currentCard, 'front')}
            </div>
          ...
          {#if showAnswer}
            ...
            {#if backContent}
              <div class="card-back">
                ...
                <div class="card-content">
                  <!-- /skip {@html} renders Markdown card content processed by Obsidian renderer -->{@html backContent}
                </div>
              </div>
            {/if}
          {/if}
